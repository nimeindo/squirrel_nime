            ...
            <?php if(count($SearchManga)){ ?>
               <div class="row mb40">
                  <div class="col-12 col-md-7">
                     <h1 class="text-white font-bold"> <i class="far fa-eye text-lightmode-primary mr-3"></i><?php echo $TitleHeadLine ?></h1>
                  </div>
               </div>
                            ...
                            <div class="pagina">
                                <?php if($FirstPaginationManga >= $LimitRowPegination){?>
                                    <?php if($this->agent->is_mobile()){?>
                                        <a  href="<?php echo site_url('manga-search/pages/'.$KeywordSearch.'-'.$Status.'-'.($PageNowSearchManga-1)); ?> ">
                                            <i class="fas fa-chevron-left"></i>
                                        </a>
                                    <?php }else{ ?>    
                                        <a  href="<?php echo site_url('manga-search/pages/'.$KeywordSearch.'-'.$Status.'-1'); ?>">
                                ...
                                <?php if($pagManga <= $LimitRowPegination && $TotalSearchPageManga !=1) { ?>
                                    
                                        <?php if($PageNowSearchManga == $i){  ?>    
                                            <a class ="pagina-active" href="<?php echo site_url('manga-search/pages/'.$KeywordSearch.'-'.$Status.'-'.$i); ?>"> <?php echo $i ?>
                                            </a>
                                        <?php }else{ ?>    
                                            <a class ="" href="<?php echo site_url('manga-search/pages/'.$KeywordSearch.'-'.$Status.'-'.($i)); ?>"> <?php echo $i ?>
                                            </a>
                                        <?php }$pagManga++ ?>    
                                    <?php } ?>
                                <?php } ?>
                                <?php if($PageNowSearchManga < $TotalSearchPageManga ){?>
                                    ...
                                    <?php }else{ ?>    
                                        <a href="<?php echo site_url('manga-search/pages/'.$KeywordSearch.'-'.$Status.'-'.($PageNowSearchManga+1)); ?>">Next 
                                            <i class="fas fa-chevron-right"></i>
                                        </a>
                                        <a href="<?php echo site_url('manga-search/pages/'.$KeywordSearch.'-'.$Status.'-'.($TotalSearchPageManga)); ?>">
