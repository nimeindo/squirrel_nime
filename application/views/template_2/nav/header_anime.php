...
<body>
    ...
    <div class=mobile-menu>
      <div class=the-menu>
          <form action="<?php echo site_url('anime-search/'); ?>" id=form method=get itemprop=potentialAction role=search >
              <input id="s" type=text placeholder="Search anime" name="KeyW" autocomplete=off>
          </form>
          <ul id=menu-mobile-header class=menu>
              ...
              <li id=menu-item-45922 class="menu-item menu-item-type-post_type menu-item-object-page menu-item-45922"><a href="<?php echo base_url().'anime-list'?>"><i class="fas text-primary fa-server mr-2"></i>List Anime</a>
              </li>
              <li id=menu-item-45922 class="menu-item menu-item-type-post_type menu-item-object-page menu-item-45922"><a href="<?php echo base_url().'anime/genre'?>"><i class="fas text-primary fa-magic mr-2"></i>Genre Anime</a>
              </li>
              <li id=menu-item-45922 class="menu-item menu-item-type-post_type menu-item-object-page menu-item-45922"><a href="<?php echo site_url('anime-update/'); ?>"><i class="fas text-primary fa-rocket mr-2"></i>Episode Terbaru</a>
              </li>
              ...
              <div class="row align-items-center">
                  <div class="col d-flex justify-content-start align-items-center">
                      ...
                      <ul class="main-nav d-flex flex-row justify-content-start text-h4 ml-5 mb-0 mt-1" id=accordionHeaderNav>
                          ...
                          <li id=menu-item-28 class="menu-item menu-item-type-post_type menu-item-object-page menu-item-28"><a href="<?php echo base_url().'anime-list'?>">List Anime</a>
                          </li>
                          <li id=menu-item-28 class="menu-item menu-item-type-post_type menu-item-object-page menu-item-28"><a href="<?php echo base_url().'anime/genre'?>">Genre Anime</a>
                          </li>
                          <li id=menu-item-28 class="menu-item menu-item-type-post_type menu-item-object-page menu-item-28"><a href="<?php echo site_url('anime-update/'); ?>">Episode Terbaru</a>
                          </li>
      ...
      <nav class="navbar mobile-nav navbar-expand-lg d-md-none">
          ...
          <div class="collapse navbar-collapse" id=navbarNav>
              <ul class=navbar-nav>
                  ...
                  <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-28 menumob"><a href="<?php echo base_url().'anime-list'?>">List Anime</a>
                  </li>
                  <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-28 menumob"><a href="<?php echo base_url().'anime/genre'?>">Genre Anime</a>
                  </li>
                  <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-28 menumob"><a href="<?php echo site_url('anime-update/'); ?>">Episode Terbaru</a>
                  </li>
