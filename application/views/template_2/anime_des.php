<?php
    ...
    if($API_DetailAnime->API_TheMovieRs->Status == "Not Complete"){ 
        ...
        foreach($API_DetailAnime->API_TheMovieRs->Body->SingleListAnime as $SingleListAnime){ 
            ...
            $ListEpisode = $SingleListAnime->ListEpisode;
            $RelatedData = $SingleListAnime->RelatedData;
        }
    }
?>
<div class="fixed-spacing pd-btm-desc">
    <?php if($Notfound ==0){?>
            ...
            <section class="container container-1080">
                <div class="row d-none d-md-flex">
                    ...
                    <div class="col pl-4 text-white mb20 animeinfti">
                        <h1 class="fontsize-39 rem-25 font-bold mb-3"><?php echo $Title ?></h1>
                ...
                <div class="col-12 col-md-4 col-lg-3 anime-pic">
                    ...
                    <div class="row mb20 series-details">
                        <div class="col-6 col-md-12 mb10">
                            <a href="<?php echo base_url().'anime-streaming/'.$paramsLastEps;?>" class="btn btn-cta btn-success round roundepstr" style="width: 100%;padding: 8px 52px;">
                ...
                <div class="col pl-4 text-white text-lightmode-black mt20">
                    <div class="row mb20">
                        <div class="col genrexarea">
                            <ul class="animegenre">
                            <?php $listGenre = explode("|",rtrim($Genre, "| ")); ?>
                            <?php foreach($listGenre as $valueGenre){?>
                                <li><a href="<?php echo base_url().'anime/genre/search/'.trim($valueGenre);?>" rel="tag"><?php echo  $valueGenre;?></a></li>
                            <?php }?>
                                ...
                                <div class="col">
                                    <div class="episodelist">
                                        <div class="row offzone text-h4 py-3">
                                            ...
                                            <div class="col d-none d-sm-block lefttitle">Judul Episode</div>
                                            <div class="col-3 d-none d-sm-block">Download</div>
                                        </div>
                                        <div class="list-episode">
                                            <ul class="leps">
                                                    <?php foreach($ListEpisode as $ListEpisodeV){ ?>
                                                        <?php $params = $ListEpisodeV->SlugEp;?>
                                                        <li class="row episodes text-h4 py-3">
                                                            <div class="col-2 d-none d-sm-block">
                                                                <a href="<?php echo base_url().'anime-streaming/'.$params?>"><?php echo '0'.$i += 1; ?> </a>
                                                            </div>
                                                            <div class="col lefttitle">
                                                                <a href="<?php echo base_url().'anime-streaming/'.$params?>"> <?php echo $ListEpisodeV->Episode ?></a>
                                                            </div>
                                                            <div class="col-3 d-none d-sm-block font-regular">
                                                                <img src="https://s2.googleusercontent.com/s2/favicons?domain=www64.zippyshare.com"> 
                                                                <a href="<?php echo $ListEpisodeV->ListDownload[0]->AdflyLink ?>" target="_blank" alt="Download"">Download</a>
                                                            </div>
                                                        </li>
                                                    <?php } ?>
                    ...
                    <div class="row mb20">
                        <div class="col">
                            <?php if(count($RelatedData) > 0) {?>
                                <h2 class="mb-3 text-h2">Rekomendasi Anime</h2></div>
                            <?php }?>
                        </div>
                    <div class="row mb40">
                        <div class="col">
                            <div class="row">
                                <?php foreach($RelatedData as $RelatedDataV){ ?>
                                    <?php $SlugDetail = $RelatedDataV->SlugDetail; ?>
                                        ...
                                        <a href="<?php echo base_url().'anime-detail/des/'.$SlugDetail?>">
                                            <div class="series-card">
                                                <div class="episode-ratio background-cover" style="background-image: url('<?php echo $RelatedDataV->Image; ?>')" title="<?php echo $RelatedDataV->Title ?>">
                                                    <div class="series-detail px-3 pt-5">
                                                        <div class="">
                                                            <h4 class="text-white"><?php echo $RelatedDataV->Title ?></h4></div>
                                                        <div class="status-type text-white">
                                                            <span class="text-h6"><?php echo $RelatedDataV->Status ?></span></div>
                                                    </div>
                                                </div>
                                            </div>
                                            </a>
