            ...
            <?php if(count($SearchAnime)){ ?>
               <div class="row mb40">
                ...
                <div class="row mt40">
                    ...
                    <?php $slug = $SearchAnimeV->SlugDetail; ?>
                            ...
                            <div class="pagina">
                                <?php if($FirstPaginationAnime >= $LimitRowPegination){?>
                                    <?php if($this->agent->is_mobile()){?>
                                        <a href="<?php echo site_url('anime-search/pages/'.$KeywordSearch.'-'.$Status.'-'.($PageNowSearchAnime-1)); ?>">
                                            <i class="fas fa-chevron-left"></i>
                                        </a>
                                    <?php }else{ ?>   
                                        <a href="<?php echo site_url('anime-search/pages/'.$KeywordSearch.'-'.$Status.'-1'); ?>">
                                ...
                                <?php if($pagAnime <= $LimitRowPegination && $TotalSearchPageAnime !=1) { ?>
                                        ...
                                        <?php if($PageNowSearchAnime == $i){  ?>    
                                            <a class ="pagina-active" href="<?php echo site_url('anime-search/pages/'.$KeywordSearch.'-'.$Status.'-'.$i); ?>"> <?php echo $i ?>
                                            </a>
                                        <?php }else{ ?>    
                                            <a class ="" href="<?php echo site_url('anime-search/pages/'.$KeywordSearch.'-'.$Status.'-'.$i); ?>"> <?php echo $i ?>
                                            </a>
                                        <?php }$pagAnime++ ?>    
                                    <?php } ?>
                                <?php } ?>
                                <?php if($PageNowSearchAnime < $TotalSearchPageAnime ){?>
                                    ...
                                    <?php }else{ ?>   
                                        <a href="<?php echo site_url('anime-search/pages/'.$KeywordSearch.'-'.$Status.'-'.($PageNowSearchAnime+1)); ?>">Next 
                                            <i class="fas fa-chevron-right"></i>
                                        </a>
                                        <a href="<?php echo site_url('anime-search/pages/'.$KeywordSearch.'-'.$Status.'-'.($TotalSearchPageAnime)); ?>">
