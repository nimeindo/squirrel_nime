            ...
            <section class="container container-1080 mt40 mb80 animelist">
                <div class="row mb40">
                    ...
                    <h1 class="text-white font-bold">
                        <i class="far fa-eye text-lightmode-primary mr-3"></i>Manga List Text
                    </h1>
                    </div>
                    <div class="col mt-3 mt-md-0">
                    <div class="mode_anime text-left text-md-right text-white">
                        <a href="<?php echo base_url().'manga-list/img'?>">
                ...
                <div class="navlist">
                    ...
                    <div class="letterlist">
                       <a href="<?php echo base_url().'manga-list/txt/0'?>">ALL</a>
                       <a href="<?php echo base_url().'manga-list/txt/1'?>">#</a>
                       <?php foreach (range('A', 'Z') as $char) { ?>
                       <a href="<?php echo base_url().'manga-list/txt/'.$char ?>"><?php echo $char; ?></a>
                        <?php } ?>
                     </div>
                    </div>
                </div>
                <div class="row the-animelist-text">
                    ...
                    <div class="text-h2 alphabet mb20 text-primary font-bold">
                       <a name="."><?php echo $ListMangaV->NameIndex; ?></a>
                     </div>
                     <?php foreach($ListMangaV->ListSubIndex as $ListSubIndexV) {?>
                        ...
                        ?>
                        <a class="list-anime ONA show" href="<?php echo base_url().'manga-detail/des/'.$SlugDetail?>">
                  ...
                  <div class="pagina">
                     ...
                     <?php if($FirstPagination >= $LimitRowPegination){?>
                        <?php if($this->agent->is_mobile()){?>
                           <a  href="<?php echo site_url('manga-list/txt/'.$NameIndexVal.'/pages/'.($PageNowSearch-1)); ?>">
                              <i class="fas fa-chevron-left"></i>
                           </a>
                        <?php }else{?>
                           <a  href="<?php echo site_url('manga-list/txt/'.$NameIndexVal.'/pages/1'); ?>">
                     ...
                     <?php if($PageNowSearch == $i){  ?>    
                        <a class ="pagina-active" href="<?php echo site_url('manga-list/txt/'.$NameIndexVal.'/pages/'.$i); ?>"> <?php echo $i ?>
                        </a>
                        <?php }else{ ?>    
                        <a class ="" href="<?php echo site_url('manga-list/txt/'.$NameIndexVal.'/pages/'.$i); ?>"> <?php echo $i ?>
                        </a>
                     <?php }$pag++ ?>    
                     <?php } ?>
                     <?php } ?>
                     <?php if($PageNowSearch < $TotalSearchPage ){?>
                        ...
                        <?php }else{?>
                           <a href="<?php echo site_url('manga-list/txt/'.$NameIndexVal.'/pages/'.($PageNowSearch+1)); ?>">Next
                              <i class="fas fa-chevron-right"></i>
                           </a>
                           <a href="<?php echo site_url('manga-list/txt/'.$NameIndexVal.'/pages/'.($TotalSearchPage)); ?>">
