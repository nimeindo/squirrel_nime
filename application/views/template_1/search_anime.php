                                ...
                                <div class="col-6 col-sm-4 col-md-3 col-lg-3 mb40">
                                    <a href="<?php echo site_url('anime/'.$params); ?>">
                                        <div class="episode-card">
                                            <div class="episode-ratio background-cover" style="" title="<?php echo $SearchAnime->Title ?>">
                        ...
                        <div class="row  d-flex justify-content-center">
                            <nav aria-label="Page navigation example">
                                <ul class="pagination-2">
                                    <li class="page-item">
                                    <a href="<?php echo site_url('search/pages/1/'.$API_Keyword);?>" class="page-link" style="color:white"  aria-label="Previous">
                                            <span aria-hidden="true">&laquo;</span>
                                        </a>
                                    </li>
                                    <?php if($FirstPagination >= $LimitRowPegination){?>
                                        <li class="page-item">
                                            <a href="<?php echo site_url('search/pages/'.($PageNowSearch-1).'/'.$API_Keyword);?>" class="page-link" style="color:white; cursor: pointer;"  aria-label="Next">
                                    ...
                                    <?php for($i = $FirstPagination; $i <= $TotalSearchPage ; $i++){?>
                                        <?php if($pag <= $LimitRowPegination) { ?>
                                            <li class="page-item">
                                                <a href="<?php echo site_url('search/pages/'.($i).'/'.$API_Keyword);?>" style="color:white;cursor: pointer;" class="page-link" ><?php echo $i ?></a>
                                            </li>
                                            <?php $pag++ ?>    
                                        <?php } ?>
                                    <?php } ?>
                                    <?php if($PageNowSearch < $TotalSearchPage ){?>
                                        <li class="page-item">
                                            <a class="page-link" style="color:white; cursor: pointer;" href="<?php echo site_url('search/pages/'.($PageNowSearch+1).'/'.$API_Keyword);?>" aria-label="Next">
                                                <span aria-hidden="true">Next</span>
                                            </a>
                                        </li>
                                    <?php }?>
                                    <li class="page-item">
                                    <a class="page-link" style="color:white" href="<?php echo site_url('search/pages/'.$TotalSearchPage.'/'.$API_Keyword);?>" aria-label="Next">
