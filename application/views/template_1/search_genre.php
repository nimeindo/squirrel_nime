        ...
        <div class="update-anime">
            <div class="row">
                <div class="col-md-8 col-lg-8">
                    <h4>Search - <?php echo $KeywordGenre ?></h4>
                    <div class="jumbotron update-anime">
                        ...
                        <?php }else{?>
                            <?php foreach($API_TheMovieRs->API_TheMovieRs->Body->SearchGenreAnime as $SearchGenreAnime){ ?>
                                <?php //$params = $SearchGenreAnime->IdDetailAnime.'-'.$SearchGenreAnime->SlugDetail;?>
                                <?php $params = $SearchGenreAnime->SlugDetail;?>
                            
                            <div class="col-6 col-sm-4 col-md-3 col-lg-3 mb40">
                                <a href="<?php echo site_url('anime/'.$params); ?>">
                                        <div class="episode-card">
                                            <div class="episode-ratio background-cover" style="" title="<?php echo $SearchGenreAnime->Title ?>">
                                            <img src="<?php echo $SearchGenreAnime->Image ?>" onerror="this.src='https://pbs.twimg.com/profile_images/600060188872155136/st4Sp6Aw_400x400.jpg'" alt="<?php echo $SearchGenreAnime->Title ?>">
                                                <div class="episode-detail px-3 pt-5">
                                                    <div class="">
                                                        <h5 class="text-white"><?php echo $SearchGenreAnime->Title ?></h5>
                                                    </div>
                                                    <?php foreach($SearchGenreAnime->ListDetail as $ListDetail){ ?>
                        ...
                        <div class="row  d-flex justify-content-center">
                            <nav aria-label="Page navigation example">
                                <ul class="pagination-2">
                                    <li class="page-item">
                                    <a class="page-link" style="color:white" href="<?php echo site_url('genre/'.$KeywordGenre.'/pages/1'); ?>"  aria-label="Previous">
                                            <span aria-hidden="true">&laquo;</span>
                                        </a>
                                    </li>
                                    <?php if($FirstPagination >= $LimitRowPegination){?>
                                        <li class="page-item">
                                        <a class="page-link" style="color:white" href="<?php echo site_url('genre/'.$KeywordGenre.'/pages/'.($PageNowSearch-1)); ?>"  aria-label="Prev">
                                    ...
                                    <?php for($i = $FirstPagination; $i < $TotalSearchPage ; $i++){?>
                                        <?php if($pag <= $LimitRowPegination) { ?>
                                            <li  class="page-item">
                                                <a style="color:white" class="page-link" <a class="page-link" style="color:white" href="<?php echo site_url('genre/'.$KeywordGenre.'/pages/'.$i); ?>"  aria-label="Next"><?php echo $i ?></a>
                                            </li>
                                            <?php $pag++ ?>    
                                        <?php } ?>
                                    <?php } ?>
                                    <?php if($PageNowSearch < $TotalSearchPage ){?>
                                        <li class="page-item">
                                        <a class="page-link" style="color:white" href="<?php echo site_url('genre/'.$KeywordGenre.'/pages/'.($PageNowSearch+1)); ?>"  aria-label="Next">
                                                <span aria-hidden="true">Next</span>
                                            </a>
                                        </li>
                                    <?php }?>
                                    <li class="page-item">
                                    <a class="page-link" style="color:white" href="<?php echo site_url('genre/'.$KeywordGenre.'/pages/'.$TotalSearchPage); ?>"  aria-label="Next">
