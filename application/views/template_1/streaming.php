...
<?php }else{?>
    <?php foreach($API_TheMovieRs->API_TheMovieRs->Body->StreamAnime as $StreamAnime){ ?>
...
<div class="fixed-spacing">
        <div class="container single mt40">
            <div class="row">
                <div class="col breadcrumb m-0 text-h5"> <span><a href="#">Home</a></span> / <span><a href="<?php echo base_url().'anime/'.$params?>"><?php echo $nameDetail?></a></span> / <span><?php echo $Title?></span></div>
            </div>
            <div class="row mb30">
                <div class="col">
            ...
            <div class="row" style="position: relative;">
                ...
                <div class="col col-main pr-lg-4">
                            ...
                            <div class="col d-flex justify-content-between align-items-center plnavmob">
                                <div class="d-flex justify-content-start plnavmob">
                                    <div class="btn-ep-nav"> 
                                        ...
                                        <?php }?>
                                            <a href="<?php echo base_url().'anime/'.$params?>">
                                                <span>
                                            ...
                                            <?php foreach($API_TheMovieRs->API_TheMovieRs->Body->StreamAnime as $StreamAnime){ ?>
                                                <?php foreach($StreamAnime->DownloadList as $adflyServer){ ?>
                                                    <?php foreach($adflyServer as $adflyDwonload){ ?>
                                                        <tr id="link-101048">
                                                            <td><img src="https://s2.googleusercontent.com/s2/favicons?domain=www64.zippyshare.com"> <a href="<?php echo $adflyDwonload->AdflyLink?>" target="_blank">Download</a></td>
                        ...
                        <div class="col">
                            <div class="floatsign">
                                <div class="entry-content"> <img width="225" height="318" src="<?php echo $Image2 ?>" alt="<?php echo $Title ?>" />
                                    ...
                                    <h4>Episode Lists</h4> : <i><a href="<?php echo base_url().'anime/'.$params?>"><?php echo $nameDetail?></a></i>
                                    <br>
                    ...
                    <!-- disqus -->
                    <input id="urlStreaming" type="hidden" value="<?php echo base_url().'streaming/'.$SlugEpNow?>">
                    <div class="row mb40">
